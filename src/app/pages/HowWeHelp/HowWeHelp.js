...
<p className=" text-gray-300 ">CEO & Founder of Demo</p>
  ...
  {/* Second Main Section */}
  <div className="flex-1 p-4 justify-center mt-5 md:ml-10">
    <div className="flex flex-col">
      
      {/* First Section */}
      <div className='flex items-start'>
        <hr className="w-0.5 h-40 mx-2 my-2 bg-gray-700 border-0 rounded dark:bg-gray-700"/>
        <div className="flex flex-col gap-3 mt-5 ml-5">
          <h6 className='font-bold'>Lorem ipsum</h6>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.<br/> Donec mattis velit nulla. In hac habitasse platea dictumst.<br/> Fusce non venenatis velit. Proin luctus malesuada mauris <br/> vitae mattis. Pellentesque iaculis elit lorem.</p>
        </div>
      </div>

      {/* Horizontal Divider */}
      <hr className="ml-2 w-96 h-0.5 my-4 bg-gray-200 rounded md:my-6 dark:bg-gray-700"/>
